    ...
    <>
      <div className='video-section'>
        ...
        <div className='video-text'>
          <p>
            <span id='sherydes-bold'>She Rydes</span> is an Australian owned,
            Gold Coast based
            <br />
            company that is dedicated to providing women riders <br />
      ...
      <div
        style={{
          backgroundImage: `url(${
            process.env.PUBLIC_URL + "/images/Jackets/static-bg.png"
          })`,
