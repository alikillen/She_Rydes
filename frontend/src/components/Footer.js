        ...
        <Container>
          ...
          <Row>
            <Col sm>
              ...
              <div className='important-links'>
                <Row>
                  <Link id='footer-text' to={"/login"}>
                    Login / Sign Up
                  </Link>
                </Row>
                <Row>
                  <Link id='footer-text' to={"/Contact"}>
                    Contact
                  </Link>
                </Row>
                <Row>
                  <Link id='footer-text' to={"/SizingCharts"}>
                    Sizing Charts
                  </Link>
                </Row>
                <Row>
                ...
                <Row>
                  <Link id='footer-text' to={"/TermsandConditions"}>
                    Terms and Conditions
                  </Link>
                </Row>
                <Row>
                  <Link id='footer-text' to={"/PrivacyPolicy"}>
                    Privacy Policy
                  </Link>
                </Row>
              </div>
          ...
          <Row>
            <Col sm className='custom-copyright text-center PY-3'>
              Copyright 2020 &copy; She Rydes | All Rights Reserved | Built by
              Alison Killen and Sevda Amini
            </Col>
          </Row>
        </Container>
      </footer>
